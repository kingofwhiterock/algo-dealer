...
class AlgoManager:
    def __init__(self, user_id, user_text, *args, **kwargs):
        ...
        self.usage_text = "-*- 文法エラー -*-\n\"$help\" を開いてヘルプユーティリティを参照してください。"

        self.player_text = "ALGO Basic Dealer\n相手にルームIDを伝えてゲームを始めよう！" \
                           "\n\"$help\" を開いてヘルプユーティリティを参照してください。"

        self.joined_text = "ALGO Basic Dealer\nゲームを始めよう！\n\"$help\" を開いてヘルプユーティリティを参照してください。"

        self.invalid_text = "ごめんなさい、使えないコマンドですm(_ _)m"
    ...
    def hide(self, now_user, results):
        ...
        # check hide without attack
        s = 'player{}_hand'.format(now_user)
        hide_wo_atk_txt = 'んんん、アタックはしたかい？そうとは思えないなぁ…'
    ...
    def interrupt(self, now_user, results):
        ...
        text = 'player {}によってゲームが中断されました。\n' \
               'もう一度ルームを作り直してください。'.format(now_user)
